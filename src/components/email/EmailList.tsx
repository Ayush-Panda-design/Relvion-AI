...
const PRIORITY_COLORS: Record<string, string> = {
  ...
  FYI: 'text-slate-500 bg-slate-500/10 border-slate-500/20',
};
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map(email => {
              ...
              return (
                ...
                >
                  {/* Avatar */}
                  <div className="w-9 h-9 rounded-full bg-[#1e293b] border border-[#2d3b55] flex items-center justify-center font-bold text-sm text-[#c9a84c] shrink-0 mr-3">
